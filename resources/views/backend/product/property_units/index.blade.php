        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Property units</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <div class="card card-flush">
                        ...
                        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                            ...
                            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                <a href="{{ route('property_units.create') }}" class="btn btn-primary">
                                    {{ translate('Add New Property units') }}
                                </a>
                                <!--end::Add product-->
                            </div>
                            <!--end::Card toolbar-->
                                ...
                                <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                                    ...
                                    <thead>
                                        ...
                                        <tr class="text-center text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="text-center min-w-75px">{{ translate('Short Name') }}</th>
                                            <th class="text-center min-w-75px">{{ translate('Conversion') }}</th>
                                        ...
                                        @foreach ($property_units as $key => $property_unit)
                                            <tr>
                                                ...
                                                <td class="text-center pe-0">
                                                    <span
                                                        class="fw-bolder">{{$property_unit->id}}</span>
                                                </td>
                                                <!--begin::Category=-->
                                                <td>
                                                        ...
                                                        <div class="ms-5">
                                                            ...
                                                            <a href="{{ route('property_units.edit', ['id' => $property_unit->id, 'lang' => env('DEFAULT_LANGUAGE')]) }}"
                                                                ...
                                                                <div class="badge badge-light-success">
                                                                    {{ $property_unit->getTranslation('name') }}</div>
                                                            </a>
                                                            <!--end::Title-->
                                                        </div>
                                                    </div>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        data-href="{{ route('property_units.destroy', $property_unit->id) }}">
