                    ...
                    <div class="card card-flush">
                        ...
                        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                            ...
                            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                <a href="{{ route('property_baths.create') }}" class="btn btn-primary">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        <!--begin::Table row-->
                                        @foreach ($property_baths as $key => $property_bath)
                                            <tr>
                                                <!--begin::Checkbox-->
                                                <td class="text-center pe-0">
                                                    <span
                                                        class="fw-bolder">{{$property_bath->id}}</span>
                                                </td>
                                                <!--begin::Category=-->
                                                <td>
                                                    <div class="d-flex">
                                                        <!--begin::Thumbnail-->
                                                        <a href="{{ route('property_baths.edit', ['id' => $property_bath->id, 'lang' => env('DEFAULT_LANGUAGE')]) }}"
                                                            class="symbol symbol-50px">
                                                            @if ($property_bath->icon != null)
                                                                <span class="symbol-label"
                                                                    style="background-image:url({{ uploaded_asset($property_bath->icon) }});"></span>
                                                            @else
                                                                —
                                                            @endif
                                                        </a>
                                                        ...
                                                        <div class="ms-5">
                                                            ...
                                                            <a href="{{ route('property_baths.edit', ['id' => $property_bath->id, 'lang' => env('DEFAULT_LANGUAGE')]) }}"
                                                                ...
                                                                <div class="badge badge-light-success">
                                                                    {{ $property_bath->getTranslation('name') }}</div>
                                                            </a>
                                                            <!--end::Title-->
                                                        </div>
                                                    </div>
                                                ...
                                                <td class="text-center pe-0" data-order="2">
                                                    <span>
                                                        @if ($property_bath->banner != null)
                                                            <img src="{{ uploaded_asset($property_bath->banner) }}"
                                                ...
                                                <td class="text-center pe-0">
                                                    @if ($property_bath->icon != null)
                                                        <span class="avatar avatar-square avatar-xs width_75">
                                                            <img src="{{ uploaded_asset($property_bath->icon) }}"
                                                ...
                                                <td class="text-center pe-0" data-order="rating-3">
                                                    <label
                                                        ...
                                                        <input class="form-check-input" onchange="update_featured(this)"
                                                            value="{{ $property_bath->id }}" type="checkbox"
                                                            <?php if ($property_bath->featured == 1) {
                                                                echo 'checked';
                                                            } ?>>
                                                    </label>
                                                </td>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        data-href="{{ route('property_baths.destroy', $property_bath->id) }}">
