            ...
            <div class="tab-pane fade show active" id="kt_ecommerce_add_product_general" role="tab-panel">
                <div class="d-flex flex-column gap-7 gap-lg-6">
                  ...
                  <div class="card-body pt-0">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <label class="required form-label">{{ translate('Longitude') }}</label>
                                     <input required type="text" class="form-control mb-2" name="longitude" value="{{$product->longitude }}" />
                                </div>
                                
                                <div class="col-md-6">
                                    <label class="required form-label">{{ translate('Latitude') }}</label>
                                     <input required type="text" class="form-control mb-2" name="latitude"  value="{{$product->latitude}}" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-6 fv-row">
                            <label class="form-label">{{ translate('Property Types') }}</label>
                            <select required class="form-select mb-2" data-control="select2" data-placeholder="Select an option"
                                ...
                                @foreach ($types as $type)
                                    ...
                                    @foreach ($type->children as $child)
                                       <option value="{{ $child->id }}" @if ($product->type_id == $child->id) selected @endif>-- {{ $child->getTranslation('name') }}</option>
                                    @endforeach
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="mb-6 fv-row">
                            <label class="form-label">{{ translate('Property Purposes') }}</label>
                            <select required class="form-select mb-2" data-control="select2" data-placeholder="Select an option"  name="purpose_id" id="purpose_id">
                                @foreach ($purposes as $purpose)
                                    ...
                                    @foreach ($purpose->children as $child)
                                       <option value="{{ $child->id }}" @if ($product->purpose_child_id == $child->id) selected @endif>-- {{ $child->getTranslation('name') }}</option>
                                    @endforeach
                                @endforeach
                            </select>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select mb-2" data-control="select2" data-allow-clear="true" data-placeholder="Select an option"  name="bed_id" id="bed_id">
                                        ...
                                        @foreach ($beds as $bed)
                                            <option value="{{$bed->id}}" > {{ $bed->getTranslation('name') }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select mb-2" data-control="select2" data-allow-clear="true" data-placeholder="Select an option" name="bath_id" id="bath_id">
                                        ...
                                        @foreach ($baths as $bath)
                                            <option value="{{$bath->id}}"> {{ $bath->getTranslation('name') }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="mb-6 fv-row">
                            ...
                            <select required class="form-select mb-2" data-control="select2" data-placeholder="Select an option" name="tour_type_id" id="tour_type_id">
                                @foreach ($tours as $tour)
                                    <option value="{{$tour->id}}"> {{ $tour->getTranslation('name') }}</option>
                                @endforeach
                            </select>

                        </div>
                        <?php
                          $condition_idz = explode(',',$product->conditions);
                        ?>
                        <div class="mb-6 fv-row">
                            <label class="form-label">{{ translate('Property Conditions') }}</label>
                            <select multiple required class="form-select mb-2" data-control="select2" data-placeholder="Select an option" name="conditions" id="conditions">
                                @foreach ($conditions as $condition)
                                    <option @if(in_array($condition->id,$condition_idz)){{'selected'}} @endif value="{{$condition->id}}"> {{ $condition->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <?php
                        $amenities_idz = explode(',',$product->amenities);
                      ?>
                      <div class="mb-6 fv-row">
                          <label class="form-label">{{ translate('Property Amenities') }}</label>
                          <select multiple required class="form-select mb-2" data-control="select2" data-placeholder="Select an option" name="amenities" id="amenities">
                        ...
                        <div class="mb-6 fv-row">
                            ...
                            <select required class="form-select mb-2" data-control="select2" data-placeholder="Select an option" name="furnish_type_id" id="furnish_type_id">
                                @foreach ($furnish_types as $furnish_type)
                                    <option @if($product->furnish_type_id == $furnish_type->id) {{'selected'}} @endif value="{{$furnish_type->id}}">{{ $furnish_type->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-md-6 fv-row fv-plugins-icon-container">
                                <label class="required form-label">{{ translate('Unit Value')}}</label>
                                <input required default="0" type="number" lang="en" class="form-control mb-2" name="unit_value"
                                    value="{{$product->unit_value}}" min="0"  />
                            </div>
                        </div>
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <!--begin::Discount options-->
                                                <div class="d-none card-title">
                                                    <h3>{{ translate('Discount') }}</h3>
                                                </div>
                                                <div class="d-none d-flex flex-wrap gap-5">
                                                    ...
                                                    <!--begin::Input group-->
                                                    <div class="d-none fv-row w-100 flex-md-root pb-5">
                                                        <!--begin::Label-->
                                                        <label
                                                            class="form-label">{{ translate('Discount Type') }}</label>
                                                        <!--end::Label-->
                                                    ...
                                                    <!--begin::Input group-->
                                                    <div class="d-none fv-row w-100 flex-md-root">
                                                        <!--begin::Label-->
                                            ...
                                            <br>
                                            <div class="d-none sku_combination" id="sku_combination">
                    ...
                    <div class="d-flex flex-column gap-7 gap-lg-6 w-100 w-lg-300px">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <label class="d-none form-label">{{ translate('Categories') }}</label>
                                <select class="d-none form-select mb-2" data-control="select2" data-placeholder="Select an option"
                                ...
                                <div class="d-none text-muted fs-7 mb-7">Add product to a category.</div>
                                <a href="{{ route('categories.create') }}" class="d-none btn btn-light-primary btn-sm mb-10">
                                ...
                                <br>
                                <label class="d-none form-label">{{ translate('Brand') }}</label>
                                <select class="d-none form-select mb-2" data-control="select2" data-placeholder="Select an option"
                                ...
                                <div class="d-none text-muted fs-7 mb-7">Add product to a brand.</div>

                                <a href="{{ route('brands.index') }}" class="d-none btn btn-light-primary btn-sm mb-10">
                                    <!--begin::Svg Icon | path: icons/duotune/arrows/arr087.svg-->
                                    <span class="svg-icon svg-icon-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                            fill="none">
