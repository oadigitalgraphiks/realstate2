        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                    ...
                    @foreach (\App\Models\Language::all() as $key => $language)
                        <li class="nav-item">
                            <a class="nav-link text-reset @if ($language->code == $lang) active @else bg-soft-dark border-light border-left-0 @endif py-3"
                                href="{{ route('property_tour_types.edit', ['id' => $property_tour_type->id, 'lang' => $language->code]) }}">
                ...
                <form class="form d-flex flex-column flex-lg-row gap-7 gap-lg-10"
                    action="{{ route('property_tour_types.update', $property_tour_type->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-5 fv-row">
                                    ...
                                    <input type="text" placeholder="{{ translate('Name') }}" id="name" name="name"
                                        class="form-control mb-2" value="{{ $property_tour_type->getTranslation('name', $lang) }}"
                                        required>
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="text-muted fs-7">
                                    {{ translate('These images are visible in Property Tour Type Page Icon. Use 300x174 sizes images.') }}
                                </div>
                            </div>
                            <!--end::Card header-->
                        </div>
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10">
                                    ...
                                    <input type="text" class="form-control mb-2" name="meta_title"
                                        value="{{ $property_tour_type->meta_title }}"
                                ...
                                <div class="mb-10">
                                    ...
                                    <textarea name="meta_description" rows="5"
                                        class="form-control mb-2">{{ $property_tour_type->meta_description }}</textarea>
                                    <!--end::Editor-->
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7">Set a meta tag description to the Property Tour Type for increased
                                        SEO ranking.</div>
                                    <!--end::Description-->
                                </div>
                                <!--end::Input group-->
                                <div class="mb-10">
                                    ...
                                    <input type="text" class="form-control mb-2" placeholder="{{ translate('Slug') }}"
                                        id="slug" name="slug" value="{{ $property_tour_type->slug }}" />
                                </div>
                            </div>
                            <!--end::Card header-->
                        </div>
                    ...
                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <input type="number" name="order_level" class="form-control mb-2" id="order_level"
                                    placeholder="{{ translate('Order Level') }}" value="{{ $property_tour_type->order_level }}">
                        ...
                        <div class="card card-flush py-4 d-none">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <label for="kt_ecommerce_add_property_tour_type_store_template"
                                    class="form-label">{{ translate('Property Tour Type') }}</label>
                                <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                                    data-placeholder="Select an option" id="kt_ecommerce_add_property_tour_type_store_template"
                                    name="digital" required>
                                    <option value="0" @if ($property_tour_type->digital == '0') selected @endif>{{ translate('Physical') }}</option>
                                    <option value="1" @if ($property_tour_type->digital == '1') selected @endif>{{ translate('Digital') }}</option>
                                </select>
                            </div>
                        </div>

                        @if (get_setting('property_tour_type_wise_commission') == 1)
                            <div class="card card-flush py-4">
                                <div class="card-header">
                                    <div class="card-title">
                                ...
                                <div class="card-body pt-0">
                                    <input type="number" lang="en" min="0" step="0.01"
                                        ...
                                        value="{{ $property_tour_type->commision_rate }}">
