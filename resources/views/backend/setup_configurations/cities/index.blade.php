            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">All Cities</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                            ...
                            <div class="card card-flush">
                                ...
                                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                    ...
                                    <div class="card-title">
                                        <h2 class="h3">{{ translate('All cities') }}</h2>
                                    </div>
                                    <!--end::Card title-->
                                    <!--begin::Card toolbar-->
                                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                        ...
                                        <div class="d-flex align-items-center position-relative my-1">
                                            ...
                                            <input type="text" class="form-control form-control-solid w-250px ps-14"
                                                id="sort_city" name="sort_city" @isset($sort_city)
                                                value="{{ $sort_city }}" @endisset
                                                placeholder="{{ translate('Type city name') }}" />
                                        </div>
                                        <!--end::Search-->
                                                ...
                                                @foreach ($cities as $key => $city)
                                                    <tr>
                                                        ...
                                                        <td class="text-center pe-0">
                                                            <span
                                                                class="fw-bolder">{{ $key + 1 + ($cities->currentPage() - 1) * $cities->perPage() }}</span>
                                                        </td>
                                                        <td class="text-center pe-0">
                                                        ...
                                                        <td class="text-center">
                                                            <a href="{{ route('cities.edit', ['id' => $city->id, 'lang' => env('DEFAULT_LANGUAGE')]) }}"
